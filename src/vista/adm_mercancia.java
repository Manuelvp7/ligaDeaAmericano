 ...
 * @author rosario
 */
public class adm_mercancia extends javax.swing.JFrame {

    /**
     * Creates new form login
     */
    public adm_mercancia() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adm_mercancia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adm_mercancia().setVisible(true);
            }
        });
    }
